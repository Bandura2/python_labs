...
class Mosquito(AbstractClassInsect):
    """
    Create class Mosquito, that inheritance from Insect
    ...
    def __str__(self) -> str:
        return f"Mosquito(name={self.name}, number_of_legs={self.number_of_legs}," \
